...
def main():
    ...
    parser.add_argument("--num_workers", type=int, default=1, help="Number of workers for PLANTS docking")
    parser.add_argument("--vina_cpu", type=int, default=1, help="Unused (kept for compatibility)")
    parser.add_argument("--seed", type=int, default=None, help="Seed for random number generator")
    parser.add_argument("--vina_override", action="store_true", help="Override results of PLANTS docking")
    ...
    config = config_dict.get("plants_config") or config_dict.get("vina_config")
